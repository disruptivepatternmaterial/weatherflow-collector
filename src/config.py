...
WEATHERFLOW_COLLECTOR_STORAGE_TIMESCALEDB_ENABLED = (
    os.getenv("WEATHERFLOW_COLLECTOR_STORAGE_TIMESCALEDB_ENABLED", "False").lower()
    == "true"
)
WEATHERFLOW_COLLECTOR_TIMESCALEDB_HOST = os.getenv(
    "WEATHERFLOW_COLLECTOR_TIMESCALEDB_HOST", "localhost"
)
WEATHERFLOW_COLLECTOR_TIMESCALEDB_PORT = int(
    os.getenv("WEATHERFLOW_COLLECTOR_TIMESCALEDB_PORT", 5432)
)
WEATHERFLOW_COLLECTOR_TIMESCALEDB_DATABASE = os.getenv(
    "WEATHERFLOW_COLLECTOR_TIMESCALEDB_DATABASE", "weatherflow"
)
WEATHERFLOW_COLLECTOR_TIMESCALEDB_USER = os.getenv(
    "WEATHERFLOW_COLLECTOR_TIMESCALEDB_USER", "weatherflow"
)
WEATHERFLOW_COLLECTOR_TIMESCALEDB_PASSWORD = os.getenv(
    "WEATHERFLOW_COLLECTOR_TIMESCALEDB_PASSWORD"
)
WEATHERFLOW_COLLECTOR_TIMESCALEDB_SSLMODE = os.getenv(
    "WEATHERFLOW_COLLECTOR_TIMESCALEDB_SSLMODE", "prefer"
)
WEATHERFLOW_COLLECTOR_TIMESCALEDB_POOL_MIN = int(
    os.getenv("WEATHERFLOW_COLLECTOR_TIMESCALEDB_POOL_MIN", 2)
)
WEATHERFLOW_COLLECTOR_TIMESCALEDB_POOL_MAX = int(
    os.getenv("WEATHERFLOW_COLLECTOR_TIMESCALEDB_POOL_MAX", 10)
)
WEATHERFLOW_COLLECTOR_TIMESCALEDB_BATCH_SIZE = int(
    os.getenv("WEATHERFLOW_COLLECTOR_TIMESCALEDB_BATCH_SIZE", 500)
)
WEATHERFLOW_COLLECTOR_TIMESCALEDB_FLUSH_INTERVAL = int(
    os.getenv("WEATHERFLOW_COLLECTOR_TIMESCALEDB_FLUSH_INTERVAL", 5)
)
WEATHERFLOW_COLLECTOR_TIMESCALEDB_MAX_RETRIES = int(
    os.getenv("WEATHERFLOW_COLLECTOR_TIMESCALEDB_MAX_RETRIES", 5)
)
WEATHERFLOW_COLLECTOR_TIMESCALEDB_RETRY_DELAY = int(
    os.getenv("WEATHERFLOW_COLLECTOR_TIMESCALEDB_RETRY_DELAY", 2)
)
WEATHERFLOW_COLLECTOR_TIMESCALEDB_SCHEMA_AUTO_CREATE = (
    os.getenv("WEATHERFLOW_COLLECTOR_TIMESCALEDB_SCHEMA_AUTO_CREATE", "True").lower()
    == "true"
)
